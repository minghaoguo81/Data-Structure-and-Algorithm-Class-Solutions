...
def satisfiable_ck(n, m, clauses):
    edges, implication_g, reversed_imp_g, node_map, var_map = build_imp_graph(n, clauses)
...
def circuit_design():
    ...
    result = satisfiable_ck(n, m, clauses)
